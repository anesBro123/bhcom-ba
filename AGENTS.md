...
- **Entity tabs (user hubs):** `EntityTabsComponent` at `/home` (marketplace) and `/our-listings` (my listings); `userSearchUrl()` / `userOurListingsUrl()` — see `entity-tabs.mdc`
