...
import { EMPLOYEE_HOME_URL, SIGN_IN_URL } from '../../../shared/constants/app-urls';
...
export class EmployeeLoginPageComponent {
  ...
  protected onSubmit(): void {
    ...
    this.auth.loginEmployee({ username, password }).subscribe({
      next: () => {
        this.submitting.set(false);
        void this.router.navigateByUrl(EMPLOYEE_HOME_URL);
      },
      error: () => {
        this.submitting.set(false);
